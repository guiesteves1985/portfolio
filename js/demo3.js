...
*/
{
    ...
    class Item {
        constructor(el) {
            // the .item element
            this.DOM = {el: el};
            this.DOM.image = this.DOM.el.querySelector('.content_item-img');
    ...
    class SmoothScroll {
        constructor() {
            ...
            [...this.DOM.content.querySelectorAll('.content_item')].forEach(item => this.items.push(new Item(item)));
    ...
    const preloadImages = () => {
        return new Promise((resolve, reject) => {
            imagesLoaded(document.querySelectorAll('.content_item-img'), {background: true}, resolve);
        });
    };
